...
Router.route('/reports/invoicesDue', {
    name: 'invoicesDueReport',
    action: function() {
        this.render('reports');
        this.render('invoicesDueReport', {to: 'report'});
    }
});
...
Router.route('/reports/invoicesDue/print', {
    name: 'invoicesDueReportPrint',
    controller: 'PrintController'
});
