...
Router.route('/properties/:propertyId/:_id/activeLease', {
    name: 'activeLease',
    action: function() {
        this.render('unitView');
        this.render('activeLease', {to: 'unitView'});
    }
});

Router.route('/properties/:propertyId/:_id/futureLease', {
    name: 'futureLease',
    action: function() {
        this.render('unitView');
        this.render('futureLease', {to: 'unitView'});
    }
});
